...
==== MultiplyImage filter

[source,java]
.code
----
include::{sourcedir}/filters/MultiplyImageFilterTest.java[tags=MultiplyImageFilter]
----
image::MultiplyImageFilter.png[title="Multiply Image Filter", width="300", height="300"]

==== MultiplyImage filter with displacement

[source,java]
.code
----
include::{sourcedir}/filters/MultiplyImageFilterWithDisplacementTest.java[tags=MultiplyFilterImageWithDisplacement]
----
image::MultiplyImageFilterWithDisplacement.png[title="Multiply Image Filter With Displacement", width="300", height="300"]
